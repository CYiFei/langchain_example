...
# from langchain_community.document_loaders.epub import EPubReader
...
class RAGSystem:
    ...
    def _check_dependencies(self):
        ...
        if missing_packages:
            ...
            print("✨ 安装完整依赖可支持: PPTX, Excel, HTML, Markdown, EPUB, 图像OCR等")
            print("="*60)
